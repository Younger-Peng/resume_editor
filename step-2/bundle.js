...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _leancloudStorage = __webpack_require__(8);
	...
	var app = new _vue2.default({
	  ...
	  created: function created() {
	    ...
	    window.onbeforeunload = function () {
	      ...
	      var todoListString = JSON.stringify(_this.todoList);
	      window.localStorage.setItem('myTodos', todoListString);
	      window.localStorage.setItem('lastTodo', newTodoString);
	    };
	    var oldTodoListString = window.localStorage.getItem('myTodos');
	    var lastTodoString = window.localStorage.getItem('lastTodo');
	    var oldData = JSON.parse(oldTodoListString);
